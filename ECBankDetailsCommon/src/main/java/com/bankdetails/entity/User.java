...
//    private UserBankDetails userBankDetails;
	...
	public User(String firstName, String lastName, String email, String identityCard, String phoneNumber,
			String password) {
		super();
	...
	/*
	 * public UserBankDetails getUserBankDetails() { return userBankDetails; }
	 * 
